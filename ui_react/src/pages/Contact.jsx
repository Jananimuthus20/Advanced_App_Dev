...
const Contact = () => {
  return (
    ...
    <div class="my-6">
    <div class="max-w-6xl mx-auto bg-[#ffffff] rounded-lg">
        <div class="grid md:grid-cols-2 items-center gap-16 sm:p-10 p-4 font-[sans-serif]">
            <div>
                <h1 class="text-4xl font-extrabold text-black">Contact Us Form</h1>
                <br/>
                <p class="text-sm text-gray-500 mt-3">Have some big idea or brand to develop and need help? Then reach out we'd love to hear about your project  and provide help.</p>
                ...
                <ul class="flex mt-12 space-x-4">
                    <li class="bg-[#377eda] hover:bg-[#8078eae2] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
            ...
            <div class="p-6 rounded-lg">
                <form class="mt-8 space-y-4">
                    <input type='text' placeholder='Name'
                        class="w-full rounded-md py-3 px-4 text-sm border outline-none border-black" />
                    <input type='email' placeholder='Email'
                        class="w-full rounded-md py-3 px-4 text-sm border outline-none border-black" />
                    <input type='text' placeholder='Phone Number'
                        class="w-full rounded-md py-3 px-4 text-sm border outline-none border-black" />
                    <textarea placeholder='Message' rows="6"
                        class="w-full rounded-md px-4 text-sm pt-3 border outline-none border-black"></textarea>
                    <button type='button'
                        class="text-white bg-[#377eda] font-semibold rounded-md text-sm px-4 py-3 flex items-center justify-center w-full">
